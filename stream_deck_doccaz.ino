  ...
  public:
    ...
    uint8_t setled(void) { // Prepare the led associated
      ...
      switch (pin) {
        ...
        case BUTTON_PIN7: // If pin is the mute btn
          // Create LED. Active low.
          pinled = LED_BTN7 ;
          pinMode(pinled, OUTPUT);
          digitalWrite(pinled, LOW);
        ...
        case BUTTON_PIN6: // If pin is the mute btn
          // Create LED. Active low.
          pinled = LED_BTN6 ;
          pinMode(pinled, OUTPUT);
          digitalWrite(pinled, LOW);
        ...
        case BUTTON_PIN5: // If pin is the mute btn
          // Create LED. Active low.
          pinled = LED_BTN5 ;
          pinMode(pinled, OUTPUT);
          digitalWrite(pinled, LOW);
    ...
    void press(boolean state) {
      ...
      if (pressed == 0) {
        ...
        if (pin == BUTTON_PIN1) {         //Intro Button code
          ...
          display.display();
        } else if (pin == BUTTON_PIN3       ) {         //Alt+tab Button code
          if (activated == false) {
...
button buttons[] = {
  ...
  {BUTTON_KEY5, BUTTON_PIN3},
  {BUTTON_KEY4, BUTTON_PIN4},
  {BUTTON_KEY3, BUTTON_PIN5},
